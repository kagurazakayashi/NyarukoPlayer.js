...
function nyarukoplayer_animationinit(a){$.ajaxSetup({error:function(a,b){nyarukoplayer_consolelog&&console.error("Data loading failed: "+b);nyarukoplayer_error();return!1}});var c=nyarukoplayer_browserok();null!=c?nyarukoplayer_error(c):(nyarukoplayer_webpok=nyarukoplayer_checkWebpSupport(),$.isFunction($.cookie)&&"true"==$.cookie("disable")?(nyarukoplayer_consolelog&&console.warn("[NyarukoPlayer] Disabled by cookie."),$(".nyarukoplayer_loading").remove()):(nyarukoplayer_count=a.length,nyarukoplayer_consolelog&&
console.log("[NyarukoPlayer] Configuration loaded."),$.isFunction(nyarukoplayerCallback_ConfigurationLoaded)&&nyarukoplayerCallback_ConfigurationLoaded(),nyarukoplayer_consolelog&&console.log("[NyarukoPlayer] Loading images..."),$.each(a,function(a,b){nyarukoplayer_webp&&nyarukoplayer_webpok&&(nyarukoplayer_imgtype="webp");imgurl=nyarukoplayer_imgdir+b[0]+"."+nyarukoplayer_imgtype;nyarukoplayer_width[a]=b[1];nyarukoplayer_height[a]=b[2];nyarukoplayer_from[a]=b[3];nyarukoplayer_to[a]=b[4];nyarukoplayer_time[a]=
b[5];nimg=new Image;nimg.src=imgurl;nimg.onload=function(){nyarukoplayer_imgcache[a]=$(this);nyarukoplayer_loaded++;var b=nyarukoplayer_loaded/nyarukoplayer_count*100;nyarukoplayer_consolelog&&console.log("Loading... "+nyarukoplayer_loaded+"/"+nyarukoplayer_count+" : "+b+"%");var c=$(".nyarukoplayer_loadingok");nyarukoplayer_errord||c.html("\u8f7d\u5165\u4e2d "+b.toFixed(0)+"%");c.css("width",b+"%");nyarukoplayer_loaded==nyarukoplayer_count&&(nyarukoplayer_consolelog&&console.log("[NyarukoPlayer] Image Loaded."),
...
function nyarukoplayer_ready(){0!=$(".nyarukoplayer")?nyarukoplayer_autoplay&&nyarukoplayer_playnow(!1):nyarukoplayer_consolelog&&console.error("[NyarukoPlayer] Unable to play animation without importing related div.")}
...
function nyarukoplayer_error(a){a=void 0===a?"\u4e00\u4e9b\u8d44\u6e90\u52a0\u8f7d\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u5237\u65b0\u518d\u8bd5\u3002":a;nyarukoplayer_errord=!0;$(".nyarukoplayer_loadingok").css({width:"100%","background-color":"#FF0033",background:"linear-gradient(#FF6666, #FF0033)","text-align":"center"});$(".nyarukoplayer_loadingok").html(a);$.isFunction(nyarukoplayerCallback_Error)&&nyarukoplayerCallback_Error(a)}
